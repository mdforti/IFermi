...
class FermiSurfacePlotter(MSONable):
    ...
    def plot_matplotlib(
        ...
        isosurfaces, colors = self.get_isosurfaces_and_colors(spin=spin, colors=colors, plot_type = 'mpl')
    ...
    def plot_mayavi(
        ...
        isosurfaces, colors = self.get_isosurfaces_and_colors(spin=spin, colors=colors, plot_type = 'mayavi')
